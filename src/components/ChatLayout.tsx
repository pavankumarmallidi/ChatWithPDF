    ...
    <div className="min-h-screen bg-gray-950">
      <div className="h-screen flex">
        ...
        <div className="hidden lg:flex w-full">
          ...
          <div className="w-80 flex-shrink-0 border-r border-gray-800/50 bg-gray-900/60 rounded-r-lg">
            <ChatListView
              userEmail={userEmail}
              onPdfSelect={handlePdfSelect}
              onBackToUpload={onBackToUpload}
            ...
            {selectedPdf ? (
              ...
              <div className="h-full flex items-center justify-center bg-gray-950">
                <div className="text-center animate-fade-in">
                  <div className="w-24 h-24 bg-gradient-to-br from-gray-700 to-gray-600 rounded-2xl flex items-center justify-center mx-auto mb-8 shadow-2xl border border-gray-600/40">
                    <MessageCircle className="w-12 h-12 text-white" />
                  </div>
                  <h3 className="text-2xl font-bold text-white mb-3 tracking-tight">Select a PDF to start chatting</h3>
